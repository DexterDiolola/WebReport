<div class="sidebarHeader"><h3>Per Mac</h3></div>
	...
	<div class="permac-tb1-container">
		<div class="row ">
			...
			<ul class="nav nav-tabs permac-tb1-tab">
			  ...
			  <li class="nav-item">
			    <a class="nav-link permac-graph" data-toggle="tab" href="{{userTypeIndicator}}/reports/Charts-perDay/macs?mac={{macParam}}">Graphs</a>
			  </li>
			</ul>
		</div>
		<div class="permac-table">
			<table class="table table-hover table-sm permac-tb1">
			    ...
			    <tr ng-repeat="utilization in utilizations">
			    	<td class="td-macs"><a href="{{userTypeIndicator}}/reports/PerMac-perDay/macs?mac={{utilization.mac}}">{{utilization.mac}}</a></td>
			...
			<table class="table table-hover  permac-tb5">
				...
				<tr ng-repeat="p in packageSummary | orderBy: '-dateCreated' | filter:{isRight:'!'} ">
					...
					<td class="td-macs"><a href="{{userTypeIndicator}}/reports/PerMac-perDay/macs?mac={{p.mac}}">{{p.mac}}</a></td>
			...
			<table class="table table-hover table-sm permac-search-results">
			    ...
			    <tr ng-repeat="result in results">
			    	<td><a href="{{userTypeIndicator}}/reports/PerMac-perDay/macs?mac={{result.mac}}">{{result.mac}}</a></td>
